...
Name: {group}\record screen using current settings; Filename: java; WorkingDir: {app}\configuration_setup_utility; Parameters: -jar jruby-complete-1.6.4.jar start_stop_recording.rb
