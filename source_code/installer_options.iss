...
Name: {group}\record using current settings; Filename: java; WorkingDir: {userdesktop}; Parameters: -jar {app}\configuration_setup_utility\jruby-complete-1.6.4.jar {app}\configuration_setup_utility\start_stop_recording_just_desktop.rb
